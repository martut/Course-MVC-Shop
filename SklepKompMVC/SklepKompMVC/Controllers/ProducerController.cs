...
namespace SklepKompMVC.Controllers
{
    public class ProducerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProducerId,ProducerShortName,ProducerName")] Producer producer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProducerId,ProducerShortName,ProducerName")] Producer producer)
        {
            if (ModelState.IsValid)
            {
